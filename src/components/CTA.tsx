    ...
    <section className="py-24 md:py-32 bg-secondary relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/6 animate-pulse delay-500">
          <Music className="w-16 h-16 text-accent/20" />
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-primary/10 backdrop-blur-sm border border-primary/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-primary">Get Started Today</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-architectural mb-6">

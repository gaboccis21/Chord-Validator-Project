...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-secondary dark:bg-background">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 pt-20">
        ...
        <div className="mb-8 reveal">
          <img src={logo} alt="HarmoniQ" className="w-32 h-32 md:w-40 md:h-40 mx-auto drop-shadow-2xl" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center reveal-delayed">
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="border-primary/50 text-white hover:bg-primary/10 text-lg px-8 py-6"
          >
            Learn More
          </Button>
        </div>

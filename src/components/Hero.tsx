  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-secondary dark:bg-background">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 pt-20">
        ...
        <div className="mb-8 reveal">
          <img alt="HarmoniQ logo" decoding="async" className="w-32 h-32 md:w-40 md:h-40 mx-auto drop-shadow-2xl object-cover" src="/lovable-uploads/97ba5ad6-1c2e-4b4f-948f-0c3c45886381.png" />
        </div>
